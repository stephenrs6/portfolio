        ...
        return (
            <div className="container contents">
                ...
                <p className="flow-text">
                    Traveling, fitness, music, cars, the internet!
                {/* Apart from coding, I enjoy contributing and advocating for mental health issues. I take a lot of interest in Psychology and neuroscience.
                ...
                Understanding what motivates an individual to get up in the morning and pursue his dream allows me to ensure that my team adapts to each other, and runs like a cohesive unit.
                    ...
                    I make it an emphasis of my life to be both book-smart and street-smart. To achieve this duality, in addition to being an avid reader, I have travelled to many different countries to gain insight on the world. */}
                </p>
            </div>
            )
